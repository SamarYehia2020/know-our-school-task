  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider<CounterViewModel>(
      ...
      body: SingleChildScrollView(
        child:Consumer<CounterViewModel>(builder: (context, model, child){
          return  Column(
          ...
          reusableTextField(model.schoolName, Icons.school),
           
          const SizedBox(height: 15,),
  
          reusableTextField(model.schoolAddress, Icons.location_on_rounded),
            
          const SizedBox(height: 15,),

          reusableTextField(model.studentsNo, Icons.person),
            
          const SizedBox(height: 15,),
       
          reusableTextField(model.teachersNo, Icons.person),
